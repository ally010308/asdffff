    ...
    override fun onSensorChanged(event: SensorEvent) {
        ...
        when (sensorType) {
            ...
            Sensor.TYPE_LINEAR_ACCELERATION -> {
                ...
                label_lineX.text = resources.getString(R.string.label_lineX, line[0])
                label_lineY.text = resources.getString(R.string.label_lineY, line[1])
                label_lineZ.text = resources.getString(R.string.label_lineZ, line[2])
            ...
            */
                total_move.text = resources.getString(R.string.label_totalDis, totalD)
                total_move_between.text = resources.getString(R.string.label_betweenDis, betweenStationDis)
